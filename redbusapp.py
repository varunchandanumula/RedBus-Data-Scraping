...
# kerala bus
lists_k=[]
df_k=pd.read_csv("C:/scrappyyyy/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/bus_details/df_kerala.xlsx")
for i,r in df_k.iterrows():
    lists_k.append(r["Route_name"])

#Andhra bus
lists_A=[]
df_A=pd.read_csv("C:/scrappyyyy/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/bus_details/df_andhra.xlsx")
for i,r in df_A.iterrows():
    lists_A.append(r["Route_name"])

#Telangana bus
lists_T=[]
df_T=pd.read_csv("C:/scrappyyyy/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/bus_details/df_telangana.xlsx")
for i,r in df_T.iterrows():
    lists_T.append(r["Route_name"])

#Goa bus
lists_g=[]
df_G=pd.read_csv("C:/scrappyyyy/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/bus_details/df_goa.xlsx")
for i,r in df_G.iterrows():
    lists_g.append(r["Route_name"])

#Rajastan bus
lists_R=[]
df_R=pd.read_csv("C:/scrappyyyy/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/bus_details/df_rajasthan.xlsx")
...
# South bengal bus 
lists_SB=[]
df_SB=pd.read_csv("C:/scrappyyyy/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/bus_details/df_sb.xlsx")
for i,r in df_SB.iterrows():
    lists_SB.append(r["Route_name"])

# Haryana bus
lists_H=[]
df_H=pd.read_csv("C:/scrappyyyy/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/bus_details/df_haryana.xlsx")
for i,r in df_H.iterrows():
    lists_H.append(r["Route_name"])

#Assam bus
lists_AS=[]
df_AS=pd.read_csv("C:/scrappyyyy/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/bus_details/df_assam.xlsx")
for i,r in df_AS.iterrows():
    lists_AS.append(r["Route_name"])

#UP bus
lists_UP=[]
df_UP=pd.read_csv("C:/scrappyyyy/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/bus_details/df_up.xlsx")
for i,r in df_UP.iterrows():
    lists_UP.append(r["Route_name"])

#West bengal bus
lists_WB=[]
df_WB=pd.read_csv("C:/scrappyyyy/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/bus_details/df_wb.xlsx")
...
if web=="Home":
    ...
    slt.subheader(":blue[Developed-by:]  Varun Chand")
...
if web == "📍States and Routes":
    ...
    if S == "Kerala":
        ...
        def type_and_fare(bus_type, fare_range):
            connection = sqlite3.connect("C:/scrappyyyy/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/DBsql/redbusdatabase.db")
            ...
            '''
            my_cursor.execute(query) # type: ignore
            out = my_cursor.fetchall()  # type: ignore
            connection.close()
    ...
    if S=="Haryana":
        ...
        def type_and_fare_H(bus_type, fare_range, A):
            connection = sqlite3.connect("C:/scrappyyyy/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/DBsql/redbusdatabase.db")
            my_cursor = connection.cursor()
            # Define fare range based on selection
            if fare_range == "50-1000":
    ...
    if S=="Assam":
        ...
        def type_and_fare_AS(bus_type, fare_range, AS):
            connection = sqlite3.connect("C:/scrappyyyy/Data-Scraping-with-Selenium-Dynamic-Filtering-using-Streamlit-main/DBsql/redbusdatabase.db")
            my_cursor = connection.cursor()
            # Define fare range based on selection
            if fare_range == "50-1000":
